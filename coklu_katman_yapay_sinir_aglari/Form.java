    ...
    public Form() {
        ...
        Ayarlari_Setle_Button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
              ...
              JOptionPane.showMessageDialog(null, "Gizli Katman Nöron Sayısı  : "+ara_katman_noron_sayisi+"\nSon Katman Nöron Sayısı  : "+sinif_sayisi);
        ...
        sifirla_butonu.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
              ...
              sinif_sayisi = 0;
              ara_katman_noron_sayisi = 0;
              
              input_normalize.get(0).clear();
              input_normalize.get(1).clear();
              input.get(0).clear();
              input.get(1).clear();
              etiket.clear();
              
              imagePanel.koordinat_ciz();
              Orneklerin_Sinifi_Combobox.revalidate();
              Orneklerin_Sinifi_Combobox.removeAllItems();
              Orneklerin_Sinifi_Combobox.repaint();
